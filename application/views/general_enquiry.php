      ...
      <div class="combined-search-row">
        <div class="table-responsive">
          <div class="text-right export-btn">
              <form action="<?php echo base_url().'general/export_excel'?>" method="post">
          ...
          <table class="table table-striped responsive" id="users">
            ...
            <tbody>
              ...
              <tr>
                <td><?php echo $i;?></td>
                <td><a href="<?php echo base_url().'general/enquiry_details/'.$val['enquiry_id'];?>"><?php echo $val['enquiry_id'];?></a></td>
