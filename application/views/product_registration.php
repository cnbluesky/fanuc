      ...
      <div class="combined-search-row">
        <div class="table-responsive">
          <div class="text-right export-btn">
              <form action="<?php echo base_url().'product/export_excel'?>" method="post">
          ...
          <table class="table table-striped responsive" id="users">
            ...
            <tbody>
              ...
              <tr>
                <td><?php echo $i;?></td>
                <td><a href="<?php echo base_url().'product/product_registration_details/'.$val['product_registration_id'];?>"><?php echo $val['product_registration_id'];?></a></td>
                <td><?php echo $val['name'];?></td>
                <td><?php echo $val['product_category_name'];?></td>
                <td><?php echo $val['machine_model'];?></td>
