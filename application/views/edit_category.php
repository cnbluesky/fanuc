          ...
          <div class="col-sm-4 col-sm-offset-4">
            <div class="change-password">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="product_category_name" class="form-control" placeholder="Category Name" value="<?php echo $category['product_category_name'];?>">
                </div>
                <div class="form-group">
                    <textarea name="product_category_description" class="form-control" placeholder="Description"><?php echo $category['product_category_description'];?></textarea>
                </div>
