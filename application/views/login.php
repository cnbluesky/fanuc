        ...
        <div id="login">
            ...
            <div class="login-form">
                ...
                <form class="form-horizontal" action="" id="login_form" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-sm-8 col-xs-6 forgot-pass"><a href="<?php echo base_url(); ?>login/forgot_password">Forgot Password</a></div>
                        <div class="col-sm-4 col-xs-6 sign-btn">
                            <button type="submit" class="btn" id="login_but">Sign In</button>
                        </div>
                    </div>
                </form>
            </div>
