                    ...
                    <div class="combined-search-row">
                        <div class="table-responsive">
                            ...
                            <div class="text-right export-btn">
                                <form action="<?php echo base_url().'state/add_state'?>" method="post">
                                ...
                                <tbody>
                                    ...
                                    foreach ($state as $val) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url().'state/edit_state/'.$val['state_id']?>">Edit</a></td>
                                            <td><a href="<?php echo base_url().'state/delete_state/'.$val['state_id']?>" onclick="return confirm('Are you want to delete this ?');">Delete</a></td>
                                        </tr>
                                    <?php } ?>
