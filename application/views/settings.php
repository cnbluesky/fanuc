          ...
          <div class="col-sm-4 col-sm-offset-4">
            <div class="change-password">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="admin_email" class="form-control" placeholder="Admin Email" value="<?php echo $user['admin_email'];?>">
                </div>
                
                
                <div class="form-group submit">
                    <button type="submit" class="btn" id="login_but">Update Email</button>
                </div>
              </form>
            </div>
          </div>
